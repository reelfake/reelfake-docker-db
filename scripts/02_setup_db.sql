...
COPY public.genre(genre_name) FROM '/docker-entrypoint-initdb.d/data/genres.csv' DELIMITERS ',' CSV header;
COPY public.movie_language(language_name, iso_language_code) FROM '/docker-entrypoint-initdb.d/data/languages.csv' DELIMITERS ',' CSV header;
COPY public.country(country_name, iso_country_code) FROM '/docker-entrypoint-initdb.d/data/countries.csv' DELIMITERS ',' CSV header;
COPY public.city(city_name, state_name, country_id) FROM '/docker-entrypoint-initdb.d/data/cities.csv' DELIMITERS ',' CSV header;
COPY public.movie(tmdb_id, imdb_id, title, original_title, overview, runtime, release_date, genre_ids, origin_country_ids, language_id, movie_status, popularity, budget, revenue, rating_average, rating_count, poster_url) FROM '/docker-entrypoint-initdb.d/data/movies.csv' DELIMITERS ',' CSV header;
COPY public.actor(tmdb_id, imdb_id, actor_name, biography, birthday, deathday, place_of_birth, popularity, profile_picture_url) FROM '/docker-entrypoint-initdb.d/data/actors.csv' DELIMITERS ',' CSV header;
COPY public.movie_actor(movie_id, actor_id, character_name, cast_order) FROM '/docker-entrypoint-initdb.d/data/movie_actors.csv' DELIMITERS ',' CSV header;
COPY public.address(address_line, city_id, postal_code, in_use_by) FROM '/docker-entrypoint-initdb.d/data/addresses.csv' DELIMITERS ',' CSV header;
COPY public.staff(first_name, last_name, email, address_id, store_id, active, phone_number, avatar, user_password) FROM '/docker-entrypoint-initdb.d/data/staff.csv' DELIMITERS ',' CSV header;
COPY public.store(store_manager_id, address_id, phone_number) FROM '/docker-entrypoint-initdb.d/data/stores.csv' DELIMITERS ',' CSV header;
COPY public.customer(first_name, last_name, email, address_id, preferred_store_id, active, phone_number, avatar, registered_on, user_password) FROM '/docker-entrypoint-initdb.d/data/customers.csv' DELIMITERS ',' CSV header;
COPY public.inventory(movie_id, store_id, stock_count) FROM '/docker-entrypoint-initdb.d/data/inventory.csv' DELIMITERS ',' CSV header;
COPY public.rental(customer_id, staff_id, inventory_id, rental_start_date, rental_end_date, return_date, delayed_by_days, amount_paid, discount_amount, payment_date, rental_type) FROM '/docker-entrypoint-initdb.d/data/rentals.csv' DELIMITERS ',' CSV header;
